...
const PATHS: Record<GomiKey, React.ReactNode> = {
  ...
  plastic: (
    <>
      <path d="M10 3.5h4v1.8c0 .7.3 1 .8 1.4.6.5 1 1.2 1 2.1V20a1 1 0 0 1-1 1H9.2a1 1 0 0 1-1-1V8.8c0-.9.4-1.6 1-2.1.5-.4.8-.7.8-1.4Z" />
      <path d="M10.5 13.5 12 11l1.5 2.5-3 0Z" />
    </>
  ),
  // 古紙：新聞・紙束
  paper: (
