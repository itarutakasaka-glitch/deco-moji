...
export async function GET(
  ...
  const allText =
    "ゴミ出し占い 目黒区 品川区 台東区 江東区 文京区 中央区 大田区 世田谷区 練馬区 江戸川区 杉並区 板橋区 新宿区 渋谷区 荒川区 東京 今日のゴミ 運勢 開運作法 収集なし ごみ収集日カレンダーのを丁目で検索 燃やす資源古紙水銀製品陶器金属ガラスプラスチックマーク容器包装可燃不燃びん缶かんペットボトル decomoji.xyz/trash-day #年月日()・/0123456789NRSU" +
    areaText +
    f.dateLong +
    f.rank.t +
    f.rank.s +
